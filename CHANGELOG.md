...
> 2026-08-30 重建：原 v2.0–v4.0.0 共 11 个版本的全部有价值更新合并进 v2.0.0，版本线统一为 1.0 → 2.0。
> 发版惯例：小修原地更新最新 release（CI 自动重建资产）；版本号不再为日常迭代上调。

## v2.0.0 · 完整形态：双面板 + 去广告体系 + 三层自愈 + 新手三件套

> Tag: `v2.0.0` · 2026-08-30（合并自 2026-08-27 ~ 08-30 的全部迭代）
